    ...
    <div className="todoList">
      ...
      {todoList.length > 0 ? (
        <>
          ...
          <ListGroup className="todoListChild">
            {todoList.map(list => (
              <ListGroup.Item variant={list.complete === true ? "success" : "primary"} key={list.name}>
                <Row>
                  <Col md={8} xs={8}>
                    - {list.name}
                  </Col>
                  ...
                  <Col md={2} xs={2}>
                    {list.complete === true ? (
                      <Button variant="success" onClick={() => handleNotComplete(list.name)}>
                        <i className="fas fa-check"></i>
                      </Button>
                    ) : (
                      <Button variant="danger" onClick={() => handleComplete(list.name)}>
                  ...
                  <Col md={2} xs={2}>
                    <Button variant="dark" onClick={() => handleDelete(list.name)}>
